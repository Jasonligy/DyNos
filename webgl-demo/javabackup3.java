...
//				Node node0 = graph.newNode("0" );
//		presence.set(node0, EvoBuilder.defaultAt(false)
//				.withConst(Interval.newClosed(0,100), true)
//				.build());
//		position.set(node0, new Evolution<>(new Coordinates(0, 0)));
//
//		Node node1 = graph.newNode("1" );
//		presence.set(node1, EvoBuilder.defaultAt(false)
//				.withConst(Interval.newClosed(0,100), true)
//				.build());
//		position.set(node1, new Evolution<>(new Coordinates(10, 10)));
//
//				Node node2 = graph.newNode("2" );
//		presence.set(node2, EvoBuilder.defaultAt(false)
//				.withConst(Interval.newClosed(0,100), true)
//				.build());
//		position.set(node2, new Evolution<>(new Coordinates(10, 5)));
//
//		Edge edge0 = graph.newEdge(node0,node1);
//		edgePresence.set(edge0, new Evolution<>(false));
//		edgeColor.set(edge0, new Evolution<>(Color.BLACK));
//		Interval relationPresence = Interval.newRightClosed(
//				10,40);
//		Interval relationPresence01 = Interval.newRightClosed(
//				50,80);
//		edgePresence.get(edge0).insert(new FunctionConst<>(relationPresence, true));
//		edgePresence.get(edge0).insert(new FunctionConst<>(relationPresence01, true));
//
//		Edge edge1 = graph.newEdge(node1,node2);
//		edgePresence.set(edge1, new Evolution<>(false));
////		edgePresence.get(edge1).insert(new FunctionConst<>(relationPresence, true));
//		edgeColor.set(edge1, new Evolution<>(Color.BLACK));
//		Interval relationPresence1 = Interval.newRightClosed(
//				10,80);
//		edgePresence.get(edge1).insert(new FunctionConst<>(relationPresence1, true));
//
//		System.out.println("check");
//		Evolution<Boolean> edgeEvolution = edgePresence.get(edge0);
////		for (Function<Boolean> function : edgeEvolution) {
