function animate(graph){
    ...
    function getNodeEdge(graph, timeframe){
        ...
        console.log(nodePosition instanceof Map);
        ...
        nodePosition.forEach((block,id) =>
        {
            ...
            currentPosition.set(id,block.valueAt(3*timeframe/totalFrame)-1);
        }
        )
        let nodes =[];
        ...
        for(const edge of edges){
            ...
            const first = edge.sourceNode;
            const second =edge.targetNode;
            ...
            console.log(currentPosition.get(first));
    ...
    function animate(timestamp) {
        ...
        updateNodePositions(elapsedTime);  // Update node positions every second
